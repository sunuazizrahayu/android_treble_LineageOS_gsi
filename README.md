...
<manifest>
    ...
    <!-- Kompatibilitas vendor lama (Android 9/10/11); tanpa ini HP
         dengan vendor tua bisa bootloop -->
    <project path="prebuilts/vndk/v28" remote="github" name="naz664/prebuilts_vndk_v28" revision="master" />
